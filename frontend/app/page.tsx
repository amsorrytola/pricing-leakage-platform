        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <h1 className="mb-6 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-600 bg-clip-text text-5xl font-bold leading-tight tracking-tight text-transparent md:text-6xl">
              ...
              <br />
              Hidden Inside Commercial Contracts
            </h1>
            ...
            <p className="mb-10 max-w-3xl text-lg leading-relaxed text-slate-600">
              ...
              commercial contracts—surface underpricing, expired discounts, and
              missed escalations with full explainability.
            </p>
            ...
            {[
              {
                ...
                desc: "Complex, unstructured pricing terms buried in contracts",
              },
              {
                title: "Silent Drift",
                desc: "Discounts carry forward beyond intended validity periods",
              },
              {
                title: "Missed Escalations",
                desc: "Escalation clauses inconsistently applied or overlooked",
              },
              {
                title: "Team Silos",
                desc: "Different teams negotiate overlapping pricing terms",
              },
              {
                title: "No Visibility",
                desc: "Leadership lacks centralized pricing deviation insights",
              },
              {
                title: "Revenue Loss",
                desc: "Resulting in leakage, erosion, and uncontrolled drift",
              },
            ].map((item, i) => (
              <div
                key={i}
            ...
            {[
              {
                ...
                desc: "Upload commercial contracts and pricing addendums securely",
              },
              {
                step: "02",
                title: "Extract Pricing Terms",
                desc: "Identify transaction fees, discounts, tiers, and escalation clauses",
              },
              {
                step: "03",
                title: "Normalize Pricing",
                desc: "Compare contract terms against your standard pricing catalogue",
              },
              {
                step: "04",
                title: "Surface Leakage",
                desc: "Detect underpricing, expired concessions, and missed escalations",
              },
            ].map((item, i) => (
