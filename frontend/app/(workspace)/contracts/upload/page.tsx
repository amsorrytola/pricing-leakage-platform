  ...
  async function handleUpload() {
    ...
    try {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE}/api/contracts/upload`,
        {
          method: "POST",
          body: formData,
        }
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-600">
          Upload a commercial contract for analysis and revenue leakage
          detection
        </p>
      </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500">
                    Provide client information and upload the contract file
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 space-y-6">
              <div>
                ...
                <p className="mt-2 text-xs text-slate-500">
                  The name of the client associated with this contract
                </p>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Real-time preview of your contract
                    </p>
                  </div>
                </div>
              </div>
