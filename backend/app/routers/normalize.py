...
from app.routers.service_log import generate_service_log
...
from rag_contract.normalized_table import normalized_table_groq,normalized_table
...
def normalize_contract(contract_id: str):
    ...
    # ------------------------------------------------------------------------
    normalized_terms = normalized_table_groq(contract_id)

    # Generate service log AFTER normalization
    generate_service_log(contract_id)
